...
type TaskPrivateData struct {
	...
	BillingSource      string              `json:"billing_source,omitempty"`       // wallet / subscription / recharge_promotion / mixed
	SubscriptionId     int                 `json:"subscription_id,omitempty"`      // subscription ID used by fallback funding
	PromotionRequestId string              `json:"promotion_request_id,omitempty"` // request-idempotent promotion reservation
	PromotionModelName string              `json:"promotion_model_name,omitempty"` // normalized client model matched by promotion
	PromotionQuota     int                 `json:"promotion_quota,omitempty"`      // promotion portion of the task pre-consume
